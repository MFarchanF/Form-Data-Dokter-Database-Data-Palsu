...
<body>
    <header>
        ...
        <nav class="nav justify-content-end">
            <a class="nav-link" href="lihat_dokter.php">Data Dokter</a>
            <a class="nav-link" href="jumlah_jenis_dokter_pasien.php"><b>Jumlah Dokter</b></a>
        ...
        <div class="card mt-3">
            <div class="card-header bg-success text-white">
                <div class="daftar_dokter">
                    <a href="jumlah_jenis_dokter_pasien.php">Jenis Dokter dan Jumlah Dokter</a>
                </div>
            </div>
